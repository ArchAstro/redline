...
files to `~/.redline/extension`. It is idempotent; re-run anytime to update.
...
4. Pick `~/.redline/extension/` if you ran `redline setup`, or the
   `extension/` directory if you are developing from a repo checkout
