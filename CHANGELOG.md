...
- dbc9ea8: Fix Chromium pairing handoff validation, target Google Chrome on macOS setup, and skip synchronous pixel decompression on existing screenshot startup checks.
